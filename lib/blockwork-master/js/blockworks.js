/*
 * blockworks 0.1
 * License: GNU General Public License as published by the Free Software Foundation - http://opensource.org/licenses/GPL-3.0
 */

//Create the includethis shortcode
...
//Function to use includethis shortcode to include defined html file
$('body').shortcode({
  includethis: function() {
    return '<div class="js-include" title="' + this.options.file + '.html"></div>';
  }
});
